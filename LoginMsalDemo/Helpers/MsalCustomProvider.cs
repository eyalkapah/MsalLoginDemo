...
{
    public class MsalCustomProvider : BaseProvider
    {
        /// <summary>
        ...
        public MsalCustomProvider(IPublicClientApplication client, string[] scopes = null, bool autoSignIn = true)
        {
            Client = client;
        ...
        public MsalCustomProvider(string clientId, string[] scopes = null, string redirectUri = null, bool autoSignIn = true, bool listWindowsWorkAndSchoolAccounts = true, string tenantId = null)
        {
        ...
        protected IPublicClientApplication CreatePublicClientApplication(string clientId, string tenantId, string redirectUri, bool listWindowsWorkAndSchoolAccounts)
        {
            string Authority = string.Format(CultureInfo.InvariantCulture,
                "https://login.microsoftonline.com/{0}/v2.0", "56073e36-70f8-4305-8a33-28d46bdf0ddc");
